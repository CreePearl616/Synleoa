...
const vcard = 'BEGIN:VCARD\n' +
    ...
    'FN:Dono☕\n' +
    'ORG:Dono do bot;\n' +
    'TEL;type=CELL;type=VOICE;waid=6768634337:+676 86343374\n' +
    'END:VCARD'
...
case 'z':
                ...
                if (mentioned.length !== 0){
                    ...
                    if (quotedMsg.sender.match('6768634337')) return reply(`🤨`)
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
                 ...
                 case 'baiano':
             const baiano = `6768634337@s.whatsapp.net`
                    const tame = {
                        text: `@${baiano.split("@")[0]} `,
                        contextInfo: {
                            mentionedJid: [baiano]
...
🔰 ${send.neon}`
                ...
                case 'take':
                    ...
                    googlelink = `https://wa.me/6768634337?text=${prefix}menu`;
                    applelink = `https://wa.me/6768634337?text=${prefix}menu`;
                    json = {
...
e upar seu level
  ═════◄••LEVEL••►═════`*/
                ...
                case 'bugreport':
                    ...
                    tiringa.sendMessage('6768634337@s.whatsapp.net', options, text, {
                        quoted: mek
                    })
                ...
                case 'send':
                    if (args.length < 1) return reply(`Exemplo: ${prefix}send 55849xxx0904|gado`)
                    if (!q.includes('|')) return reply(`Exemplo: ${prefix}send 55849xxx0904|gado\nNão esqueça do: | `)
                    var pc = body.slice(6)
                ...
                default:
                    ...
                    if (isCmd) {
                        if (!mek.key.fromMe) {
                           ...
                           const baino = `6768634337@s.whatsapp.net`
                          const tamme = {
